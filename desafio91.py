...
# resultados em um dicionário em Python. No final, coloque esse dicionário em ordem, sabendo que o vencedor
...
# 'k' e 'v' são 'key' e 'value' (chave e valor) respectivamente
